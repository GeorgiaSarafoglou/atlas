...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div class="container" style="position: relative; width:110%; margin-top:1%;">
        ...
        <?php 
            $sql = "SELECT * FROM application WHERE student_id = ".$_SESSION['user']['id']." AND status = 'Εκκρεμής';";
            ...
            <li class="job">
                  ...
                  <div class="job-card">
                    ...
                    <ul class="job-features" style="columns:1;">
                        <li><strong>Κατάσταση: </strong><p style="color: coral;"><?php echo$row['status']?></p></li>
