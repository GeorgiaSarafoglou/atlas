        ...
        <div class="main-box" style="margin-left: 10%; width:100%;background-color: transparent;border:none;">
            ...
            <jobs>
                <?php 
                    ...
                    $query = "SELECT * FROM ads WHERE company_id = '$id' AND published = 0" ;
                        ...
                        <div class="job-card">
                            <div class="top-line">
                                ...
                                <!-- DELETE BUTTON -->
                                 ...
                                 <form method="POST" action="delete-job.php" style="order:3;">
                                    <input type="hidden" name="ad-id" value="<?php echo $row['id']; ?>">
                                    <button name="delete-job" type="submit" class="btn btn-danger">Διαγραφή</button>
                                </form>
