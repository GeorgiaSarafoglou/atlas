                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text-container">
                            ...
                            <!-- Search bar -->
                            <form action="/jobs/search.php" method="POST">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a style="color:#00bfd8" href="../jobs/create-job-offer.php">Δημιουργήστε Αγγελία</a></h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a style="color:#00bfd8" href="../jobs/jobs-all.php">Δείτε Αιτήσεις Ενδιαφέροντος</a></h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a style="color:#00bfd8" href="../jobs/jobs-all.php">Έγκριση Αίτησης</a></h4>
