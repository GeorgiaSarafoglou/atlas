    ...
    <header class="header" style="height: 80%;">
        <div class="header-content">
            <div class="row" style="width: 100%;">
                ...
                <div id="left-menu">
                    <ul>
                        <li><a href="./php/search.php">Αναζήτηση Θέσεων</a></li>
                        <li><a href="./php/my-applications.php">Οι Αιτήσεις Μου</a></li>
                        <li><a href="#">Αγαπημένα</a></li>
                        <li><a class="btn btn-primary" href="php/logout.php">Αποσύνδεση</a></li>
                    </ul>
                </div>
    <!-- end of navigation and student menu -->
            <div class="container">
                <div class="row">
                    <!-- vertical menu left of page -->
                    <div class="col-lg-6">
